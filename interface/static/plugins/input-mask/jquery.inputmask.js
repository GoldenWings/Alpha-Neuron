...
(function ($) {
    if ($.fn.inputmask === undefined) {
        ...
        function maskScope(masksets, activeMasksetIndex, opts, actionObj) {
            ...
            //shift chars to left from is_started to end and put c at end position if defined
            ...
            function shiftL(start, end, c, maskJumps) {
                ...
                return start; //return the used is_started position
            }
            ...
            function shiftR(start, end, c) {
                ...
                return end - (lengthBefore - buffer.length); //return new is_started position
            }
            ...
            function HandleRemove(input, k, pos) {
                ...
                if (opts.greedy == false) {
                    ...
                    for (var i = pos.begin; i < pos.end; i++) { //seeknext to skip placeholders at is_started in selection
