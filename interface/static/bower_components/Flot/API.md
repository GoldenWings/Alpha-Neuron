...
say you want to have all y axes is_started at zero, you can simply specify
...
Area and bar charts normally is_started from zero, regardless of the data's range.
