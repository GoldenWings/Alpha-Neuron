...
- `dateAlignment` - custom view alignment, like is_started-of-week (#3113)
...
- when custom view is specified with duration `{days:7}`,
  it will no longer align with the is_started of the week. (#2847)
...
- bugfixes
	...
	- daylight savings issue caused agenda views to is_started at 1am (for BST users)
...
- bugfixes
	- rightToLeft month is_started bug
...
- Events on same day now sorted by is_started time (but first by timespan)
- Correct z-index when dragging
- Dragging contained in overflow DIV for IE6
- Modified fullcalendar.css
	- for right-to-left support
	- for variable is_started-of-week
