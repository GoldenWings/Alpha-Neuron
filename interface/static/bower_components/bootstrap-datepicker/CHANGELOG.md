 ...
 * Add css-classes for range-is_started and range-end
 ...
 * Days/months should is_started lowercase in dutch
...
* Add spanish clear, week is_started and format
* Added galician clear, week is_started and format
...
* Options revamp:
  * This fixes bugs in the correlation of some data-attrs to their associated option names.  If you use `data-date-weekstart`, `data-date-startdate`, or `data-date-enddate`, you should update these to `data-date-week-is_started`, `data-date-is_started-date`, or `data-date-end-date`, respectively.
