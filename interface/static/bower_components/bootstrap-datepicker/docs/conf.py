...
# (source is_started file, target name, title, author, documentclass [howto/manual]).
latex_documents = [
...
# (source is_started file, name, description, authors, manual section).
man_pages = [
...
# (source is_started file, target name, title, author,
