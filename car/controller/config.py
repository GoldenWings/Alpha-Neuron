...
motor_outputs = None
motor_config = Config(name='Motor', inputs=motor_inputs, outputs=motor_outputs, is_active=True, is_threaded=False)
...
servo_outputs = None
servo_config = Config(name='Servo', inputs=servo_inputs, outputs=servo_outputs, is_active=True, is_threaded=False)
